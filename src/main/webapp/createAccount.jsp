                ...
                <div class="row">
                    <div class="col-12 col-sm-8 col-md-6 mx-auto">
                        <div class="card border-3 shadow">
                            <h1 class= "display-6 bg-secondary text-white font-consolas text-center">Create Account</h1>
                            ...
                            <form class="form-control" action="createAccount" method="post">
                                ...
                                <div class="mb-3">
                                    <label for="password_create" class="form-label">Create Password:</label>
