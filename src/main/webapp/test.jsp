...
<body>
    ...
    <header class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
        <svg class="justify-content-left mx-auto bi bi-bank2" fill="seagreen" xmlns="http://www.w3.org/2000/svg" width="75" height="75" class="" viewBox="0 0 16 16">
        ...
        <div class="navbar-nav">
            <div class="nav-item text-nowrap">
                 <button type="button" action="" method="" class="btn btn-lg btn-outline-success">Sign Out</button>
            </div>
        </div>
    </header>
      ...
      <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light">
        <div class="position-sticky pt-3">
          ...
          <ul class="nav flex-column mb-2">
            <li class="nav-item">
              <a class="nav-link" href="./createTransaction.jsp">
            ...
            <li class="nav-item">
              <a class="nav-link" href="./createCategory.jsp">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-file-text" aria-hidden="true"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline><line x1="16" y1="13" x2="8" y2="13"></line><line x1="16" y1="17" x2="8" y2="17"></line><polyline points="10 9 9 9 8 9"></polyline></svg>
                Create Category
              </a>
            </li>
